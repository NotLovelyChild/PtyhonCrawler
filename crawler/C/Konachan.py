...
if __name__ == '__main__':
	...
	p=1
	while True:
		soup=Config.requestUrlWithChrome("http://konachan.wjcodes.com/?tag=rating:safe&p="+str(p))
		...
		for image in images:
			...
			Config.downloadFile(savePath="/Volumes/J/konachan/"+path,filePath=image_url,fileName=image_name+".png")
		p=p+1
